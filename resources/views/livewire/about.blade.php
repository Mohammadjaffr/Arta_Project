...
@section('contact')
    ...
    <div  class="container rounded-5 my-5" dir="rtl" style="background-color: rgba(255,255,255,0.36)">
        <div class="">
            <div class="col-md-12" style="color: var(--primary-custom-color);">
                <div class="rounded-3 hover-effect">
                    <h1 class="text-center mb-4" style="color:var(--warning-custom-color)">من نحن</h1>
