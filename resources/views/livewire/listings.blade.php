...
=======
                    <a href="{{url('show_info/'.$l->id)}}" class="btn border text-white rounded-4 d-flex justify-content-center align-items-center" style="width: 100%; background-color: #046998; height: 45px;">
>>>>>>> Stashed changes
