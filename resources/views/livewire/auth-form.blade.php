<div>
    ...
    <div class="col-12 col-lg-5 custom-position container my-5 p-3 rounded-5 custom-shadow" style="background-color: #E7E7E7;min-width: 469px; max-width: 500px; max-height: fit-content;right: 15%">
            ...
            <div class="text-end my-3 me-5 text-black-50">
                ...
                <form class="my-3 mx-2" method="POST" action="{{ route('login') }}">
                    ...
                    <div class="form-group text-end my-2">
                        ...
                        <input class="form-control py-2 rounded-4 custom-input " type="text" name="login" value="{{ old('login') }}" >
                        @error('login')
