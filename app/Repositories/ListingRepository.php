...
class ListingRepository implements RepositoriesInterface
{
    ...
    public function index($region_id = null, $category_id = null)
    {
        ...
        return $query->with(['user:id,name,username,email,contact_number,whatsapp_number','category:id,name','region:id,name','images','comments.user','currency:code,name'])->filter()->paginate(10);
    }
